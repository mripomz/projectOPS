module.controller('SalesAgencyCtrl',["$scope", "$timeout", "$cookies", "$modal", "Helpers", "Modals", "Pages", "Users", "Sales", "Routes", function ($scope, $timeout, $cookies, $modal, Helpers, Modals, Pages, Users, Sales, Routes) {
