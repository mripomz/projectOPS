...
angular.module('cfp.loadingBar', [])
  .provider('cfpLoadingBar', function() {
    ...
    this.spinnerTemplate = '<div id="loading-bar-spinner"><span style="font-size:50px"><i class="fa fa-spinner fa-spin"></i></span></div>';
    this.loadingBarTemplate = '<div id="loading-bar"><div class="bar"><div class="peg"></div></div></div>';
    this.backdropTemplate = '<div class="modal-backdrop fade in" ng-class="{in: animate}" style="z-index: 1040;background-color: #6b6b6b;"></div>';
