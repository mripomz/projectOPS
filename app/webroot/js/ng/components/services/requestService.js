module.service('requestService', function ($http, $rootScope, $cookies) {
    ...
    return function (params) {
        ...
        request.http = $http({
            method: params.verb,
            url: api + '/' + params.controller + (params.endpoint ? '/' + params.endpoint : '') + "?accessToken=" + token + "&language=" + language,
            params: params.query,
            data: params.body,
            async: false,
