...
<div id="sidebar" class="st-pusher">
	...
	<div class="st-content" id="content" ng-controller="TaxInsuranceCtrl" ng-init="initData(3);SellingName = '<?php echo $userDetail->Name;?>'">
		<div class="st-content-inner">
        	<div class="container-fluid">
        		<div class="panel panel-default">
        			<div class="panel-heading" style="padding-bottom: 20px">
        				<h2><?php echo __("ReportInsurance"); ?></h2>
        			</div>
                    <div class="panel panel-primary" style="border-radius:0px;border-top-right-radius:4px;">
                        ...
                        <div class="panel-body">
                            <div class="col-md-12">
                                <div ng-include="rootUrl + '../templates/Reports/TaxAndInsurance/ReportInsurance.html'">
